...
class TableauPublisher:
    ...
    def create_hyper_extract(self, df: pd.DataFrame, output_path: str, table_name: str = 'Extract'):
        ...
        table_name : str
            Name of the table in the extract
        """
    ...
    def publish_workbook(self, workbook_path: str, project_name: str, workbook_name: str = None):
        ...
        if not self.connected:
            raise Exception("Not connected to Tableau Server. Call connect() first.")
    ...
    def publish_datasource(self, datasource_path: str, project_name: str, datasource_name: str = None):
        """
        ...
        print(f"✓ Data source published successfully")
    ...
    def refresh_extract(self, datasource_id: str):
        ...
        print(f"✓ Extract refresh triggered")
    ...
    def list_workbooks(self, project_name: str = None) -> List[Dict]:
        ...
        print(f"Listing workbooks{' in project: ' + project_name if project_name else ''}...")
...
def example_pipeline():
    ...
    try:
        ...
        extract_path = publisher.create_hyper_extract(
            df, 
            '/tmp/sales_data.hyper',
            table_name='Sales'
        )
        
        # Publish data source
        print("\n3. Publishing data source...")
        ds_result = publisher.publish_datasource(
            extract_path,
